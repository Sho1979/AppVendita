...
async def run_test():
    ...
    try:
        ...
        # Click on 'Accedi o Registrati' to navigate to the login screen.
        ...
        assert False, 'Test failed: Expected error message for invalid credentials, but test execution failed.'
